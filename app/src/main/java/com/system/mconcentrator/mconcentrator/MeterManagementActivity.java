...
public class MeterManagementActivity extends Activity implements View.OnClickListener {


    private static final String TAG = "MeterManagementActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meter_management);
        initViews();
        initData();
        initLinstener();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.protocol_130bt:
                intent.setClass(getApplicationContext(),Meter130ManagementActivity.class);
                startActivity(intent);
                intent=null;
                break;
            case R.id.protocol_188bt:
                intent.setClass(getApplicationContext(),Meter188ManagementActivity.class);
                startActivity(intent);
                intent=null;
                break;
